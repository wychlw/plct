...
本测试报告中对比的环境为RevyOS在同类硬件上运行的结果。其GCC版本为GCC14，同时部分也提供了专门采用GCC-12的对比，相应使用的配置会在对比结果中说明。
...
对比（rv64gc using gcc-12）：
```log
type             16 bytes     64 bytes    256 bytes   1024 bytes   8192 bytes  16384 bytes
AES-128-GCM       9551.70k    22761.22k    35377.66k    41142.88k    43100.84k    43286.53k
AES-192-GCM       8833.27k    20808.90k    32056.66k    36968.45k    38955.69k    39146.84k
AES-256-GCM       7968.28k    19195.10k    29062.59k    33453.06k    35501.40k    35651.58k
```
